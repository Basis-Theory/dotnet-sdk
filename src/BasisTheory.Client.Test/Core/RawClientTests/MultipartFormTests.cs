...
public class MultipartFormTests
{
    ...
    private static global::BasisTheory.Client.Core.MultipartFormRequest CreateMultipartFormRequest()
    {
        return new global::BasisTheory.Client.Core.MultipartFormRequest
        {
