...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal Task<global::BasisTheory.Client.Core.ApiResponse> MakeRequestAsync(
        global::BasisTheory.Client.Core.BaseRequest request,
    ...
    internal async Task<global::BasisTheory.Client.Core.ApiResponse> SendRequestAsync(
        global::BasisTheory.Client.Core.BaseRequest request,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// </summary>
    private async Task<global::BasisTheory.Client.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    private static string BuildUrl(global::BasisTheory.Client.Core.BaseRequest request)
    {
    ...
    /// <inheritdoc />
    [Obsolete("Use global::BasisTheory.Client.Core.ApiResponse instead.")]
    internal record ApiResponse : global::BasisTheory.Client.Core.ApiResponse;

    /// <inheritdoc />
    [Obsolete("Use global::BasisTheory.Client.Core.BaseRequest instead.")]
    internal abstract record BaseApiRequest : global::BasisTheory.Client.Core.BaseRequest;

    /// <inheritdoc />
    [Obsolete("Use global::BasisTheory.Client.Core.EmptyRequest instead.")]
    internal abstract record EmptyApiRequest : global::BasisTheory.Client.Core.EmptyRequest;

    /// <inheritdoc />
    [Obsolete("Use global::BasisTheory.Client.Core.JsonRequest instead.")]
    internal abstract record JsonApiRequest : global::BasisTheory.Client.Core.JsonRequest;

    /// <inheritdoc />
    [Obsolete("Use global::BasisTheory.Client.Core.MultipartFormRequest instead.")]
    internal abstract record MultipartFormRequest
        : global::BasisTheory.Client.Core.MultipartFormRequest;

    /// <inheritdoc />
    [Obsolete("Use global::BasisTheory.Client.Core.StreamRequest instead.")]
    internal abstract record StreamApiRequest : global::BasisTheory.Client.Core.StreamRequest;
}
