...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal Task<BasisTheory.Client.Core.ApiResponse> MakeRequestAsync(
        BasisTheory.Client.Core.BaseRequest request,
    ...
    internal async Task<BasisTheory.Client.Core.ApiResponse> SendRequestAsync(
        BasisTheory.Client.Core.BaseRequest request,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// </summary>
    private async Task<BasisTheory.Client.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    )
    {
        ...
        {
            return new BasisTheory.Client.Core.ApiResponse
            {
    ...
    internal HttpRequestMessage CreateHttpRequest(BasisTheory.Client.Core.BaseRequest request)
    {
    ...
    private static string BuildUrl(BasisTheory.Client.Core.BaseRequest request)
    {
    ...
    /// <inheritdoc />
    [Obsolete("Use BasisTheory.Client.Core.ApiResponse instead.")]
    internal record ApiResponse : BasisTheory.Client.Core.ApiResponse;

    /// <inheritdoc />
    [Obsolete("Use BasisTheory.Client.Core.BaseRequest instead.")]
    internal abstract record BaseApiRequest : BasisTheory.Client.Core.BaseRequest;

    /// <inheritdoc />
    [Obsolete("Use BasisTheory.Client.Core.EmptyRequest instead.")]
    internal abstract record EmptyApiRequest : BasisTheory.Client.Core.EmptyRequest;

    /// <inheritdoc />
    [Obsolete("Use BasisTheory.Client.Core.JsonRequest instead.")]
    internal abstract record JsonApiRequest : BasisTheory.Client.Core.JsonRequest;

    /// <inheritdoc />
    [Obsolete("Use BasisTheory.Client.Core.MultipartFormRequest instead.")]
    internal abstract record MultipartFormRequest : BasisTheory.Client.Core.MultipartFormRequest;

    /// <inheritdoc />
    [Obsolete("Use BasisTheory.Client.Core.StreamRequest instead.")]
    internal abstract record StreamApiRequest : BasisTheory.Client.Core.StreamRequest;
}
