...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal async global::System.Threading.Tasks.Task<global::BasisTheory.Client.Core.ApiResponse> SendRequestAsync(
    ...
    /// </summary>
    private async global::System.Threading.Tasks.Task<global::BasisTheory.Client.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    private string BuildUrl(global::BasisTheory.Client.Core.BaseRequest request)
    {
