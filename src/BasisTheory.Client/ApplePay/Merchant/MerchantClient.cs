...
public partial class MerchantClient : IMerchantClient
{
    ...
    {
        _client = client;
        Certificates = new global::BasisTheory.Client.ApplePay.Merchant.CertificatesClient(_client);
    }

    public global::BasisTheory.Client.ApplePay.Merchant.ICertificatesClient Certificates { get; }

    private async Task<WithRawResponse<ApplePayMerchant>> GetAsyncCore(
        string id,
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<ApplePayMerchant>(responseBody)!;
    ...
    private async Task<WithRawResponse<ApplePayMerchant>> CreateAsyncCore(
    ...
    /// </code></example>
    public WithRawResponseTask<ApplePayMerchant> GetAsync(
        string id,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<ApplePayMerchant>(
    ...
    /// </code></example>
    public WithRawResponseTask<ApplePayMerchant> CreateAsync(
        ApplePayMerchantRegisterRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
