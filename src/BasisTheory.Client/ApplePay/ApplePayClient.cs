...
public partial class ApplePayClient : IApplePayClient
{
    ...
    {
        _client = client;
        Merchant = new global::BasisTheory.Client.ApplePay.MerchantClient(_client);
    ...
    private async Task<WithRawResponse<ApplePayCreateResponse>> CreateAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<ApplePayCreateResponse>(responseBody)!;
                return new WithRawResponse<ApplePayCreateResponse>()
                {
                    Data = responseData,
    ...
    private async Task<WithRawResponse<ApplePayToken>> GetAsyncCore(
        string id,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<ApplePayToken>(responseBody)!;
                return new WithRawResponse<ApplePayToken>()
                {
                    Data = responseData,
                    RawResponse = new global::BasisTheory.Client.RawResponse()
                    {
    ...
    /// </code></example>
    public WithRawResponseTask<ApplePayCreateResponse> CreateAsync(
        ApplePayCreateRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<ApplePayCreateResponse>(
    ...
    /// </code></example>
    public WithRawResponseTask<ApplePayToken> GetAsync(
        string id,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<ApplePayToken>(GetAsyncCore(id, options, cancellationToken));
    }
