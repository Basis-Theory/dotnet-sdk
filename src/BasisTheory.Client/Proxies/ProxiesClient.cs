...
public partial class ProxiesClient : IProxiesClient
{
    ...
    private WithRawResponseTask<ProxyPaginatedList> ListInternalAsync(
        ProxiesListRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<ProxyPaginatedList>(
            ListInternalAsyncCore(request, options, cancellationToken)
        );
    }

    private async Task<WithRawResponse<ProxyPaginatedList>> ListInternalAsyncCore(
        ProxiesListRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<ProxyPaginatedList>(responseBody)!;
                return new WithRawResponse<ProxyPaginatedList>()
                {
                    Data = responseData,
    ...
    private async Task<WithRawResponse<Proxy>> CreateAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<Proxy>(responseBody)!;
                return new WithRawResponse<Proxy>()
                {
                    Data = responseData,
                    RawResponse = new global::BasisTheory.Client.RawResponse()
                    {
    ...
    private async Task<WithRawResponse<Proxy>> GetAsyncCore(
        string id,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    ...
    private async Task<WithRawResponse<Proxy>> UpdateAsyncCore(
        string id,
    ...
    private async Task<RawResponse> TransferHostnameAsyncCore(
        string id,
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<Proxy> CreateAsync(
        CreateProxyRequest request,
        IdempotentRequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<Proxy>(CreateAsyncCore(request, options, cancellationToken));
    }

    /// <example><code>
    /// await client.Proxies.GetAsync("id");
    /// </code></example>
    public WithRawResponseTask<Proxy> GetAsync(
        string id,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<Proxy>(GetAsyncCore(id, options, cancellationToken));
    }
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<Proxy> UpdateAsync(
        string id,
        UpdateProxyRequest request,
        IdempotentRequestOptions? options = null,
        CancellationToken cancellationToken = default
    ...
    {
        return new WithRawResponseTask<Proxy>(
    ...
    {
        return new WithRawResponseTask(PatchAsyncCore(id, request, options, cancellationToken));
    }
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask TransferHostnameAsync(
        string id,
        TransferProxyHostnameRequest request,
        IdempotentRequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask(
            TransferHostnameAsyncCore(id, request, options, cancellationToken)
        );
    }
}
