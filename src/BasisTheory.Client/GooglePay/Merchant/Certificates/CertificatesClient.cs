...
public partial class CertificatesClient : ICertificatesClient
{
    ...
    private async Task<WithRawResponse<GooglePayMerchantCertificates>> GetAsyncCore(
        string merchantId,
        string id,
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<GooglePayMerchantCertificates>(
                    responseBody
                )!;
                return new WithRawResponse<GooglePayMerchantCertificates>()
                {
                    Data = responseData,
    ...
    private async Task<WithRawResponse<GooglePayMerchantCertificates>> CreateAsyncCore(
        string merchantId,
    ...
    /// </code></example>
    public WithRawResponseTask<GooglePayMerchantCertificates> GetAsync(
        string merchantId,
        string id,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    ...
    {
        return new WithRawResponseTask<GooglePayMerchantCertificates>(
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<GooglePayMerchantCertificates> CreateAsync(
        string merchantId,
        GooglePayMerchantCertificatesRegisterRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
