...
public partial class MerchantClient : IMerchantClient
{
    ...
    {
        _client = client;
        Certificates = new global::BasisTheory.Client.GooglePay.Merchant.CertificatesClient(
            _client
        );
    }
    ...
    private async Task<WithRawResponse<GooglePayMerchant>> GetAsyncCore(
        string id,
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<GooglePayMerchant>(responseBody)!;
                return new WithRawResponse<GooglePayMerchant>()
                {
                    Data = responseData,
    ...
    private async Task<WithRawResponse<GooglePayMerchant>> CreateAsyncCore(
    ...
    /// </code></example>
    public WithRawResponseTask<GooglePayMerchant> GetAsync(
        string id,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<GooglePayMerchant>(
    ...
    /// </code></example>
    public WithRawResponseTask<GooglePayMerchant> CreateAsync(
        GooglePayMerchantRegisterRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
