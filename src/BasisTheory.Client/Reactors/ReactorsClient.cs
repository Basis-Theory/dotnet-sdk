...
public partial class ReactorsClient
{
    ...
    /// </code>
    /// </example>
    public Pager<Reactor> ListAsync(ReactorsListRequest request, RequestOptions? options = null)
    {
        ...
        var response = await _client
            .MakeRequestAsync(
                new RawClient.JsonApiRequest
                {
                    ...
                    Path = $"reactors/{JsonUtils.SerializeAsString(id)}",
                    Options = options,
                },
                cancellationToken
            )
        ...
        var response = await _client
            .MakeRequestAsync(
                new RawClient.JsonApiRequest
                {
                    BaseUrl = _client.Options.BaseUrl,
                    Method = HttpMethod.Post,
                    Path = $"reactors/{JsonUtils.SerializeAsString(id)}/react",
                    Body = request,
                    ContentType = "application/json",
                    Options = options,
                },
        ...
        var response = await _client
            .MakeRequestAsync(
                new RawClient.JsonApiRequest
                {
                    BaseUrl = _client.Options.BaseUrl,
                    Method = HttpMethod.Post,
                    Path = $"reactors/{JsonUtils.SerializeAsString(id)}/react-async",
                    Body = request,
                    ContentType = "application/json",
                    Options = options,
                },
    ...
    private async Task<ReactorPaginatedList> ListAsync(
