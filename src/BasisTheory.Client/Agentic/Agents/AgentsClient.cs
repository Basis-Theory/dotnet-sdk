...
public partial class AgentsClient : IAgentsClient
{
    ...
    {
        _client = client;
        Instructions = new InstructionsClient(_client);
    }

    public IInstructionsClient Instructions { get; }

    private async Task<WithRawResponse<Agent>> CreateAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<Agent>(responseBody)!;
                return new WithRawResponse<Agent>()
                {
                    Data = responseData,
    ...
    private async Task<WithRawResponse<Agent>> GetAsyncCore(
        string agentId,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    ...
    private async Task<WithRawResponse<Agent>> UpdateAsyncCore(
        string agentId,
    ...
    /// </code></example>
    public WithRawResponseTask<Agent> CreateAsync(
        CreateAgentRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<Agent>(CreateAsyncCore(request, options, cancellationToken));
    }

    /// <example><code>
    /// await client.Agentic.Agents.GetAsync("agent_id");
    /// </code></example>
    public WithRawResponseTask<Agent> GetAsync(
        string agentId,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<Agent>(GetAsyncCore(agentId, options, cancellationToken));
    }
    ...
    /// </code></example>
    public WithRawResponseTask<Agent> UpdateAsync(
        string agentId,
        UpdateAgentRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    ...
    {
        return new WithRawResponseTask<Agent>(
