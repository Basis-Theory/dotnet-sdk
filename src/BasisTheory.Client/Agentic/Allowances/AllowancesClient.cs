...
public partial class AllowancesClient : IAllowancesClient
{
    private readonly RawClient _client;

    internal AllowancesClient(RawClient client)
    {
        _client = client;
        Rails = new global::BasisTheory.Client.Agentic.Allowances.RailsClient(_client);
        Credentials = new global::BasisTheory.Client.Agentic.Allowances.CredentialsClient(_client);
    }
    ...
    /// </summary>
    private WithRawResponseTask<AllowanceList> ListInternalAsync(
        AllowancesListRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<AllowanceList>(
            ListInternalAsyncCore(request, options, cancellationToken)
        );
    }

    private async Task<WithRawResponse<AllowanceList>> ListInternalAsyncCore(
        AllowancesListRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        var _queryString = new global::BasisTheory.Client.Core.QueryStringBuilder.Builder(
            ...
            .Add("payment_method_id", request.PaymentMethodId)
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<AllowanceList>(responseBody)!;
                return new WithRawResponse<AllowanceList>()
                {
                    Data = responseData,
    ...
    private async Task<WithRawResponse<Allowance>> CreateAsyncCore(
    ...
    private async Task<WithRawResponse<Allowance>> GetAsyncCore(
        string allowanceId,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    ...
    private async Task<WithRawResponse<Allowance>> UpdateAsyncCore(
        string allowanceId,
    ...
    /// </summary>
    private WithRawResponseTask<SharedPaymentProviderErrorList> ErrorsInternalAsync(
        string allowanceId,
    ...
    {
        return new WithRawResponseTask<SharedPaymentProviderErrorList>(
            ErrorsInternalAsyncCore(allowanceId, request, options, cancellationToken)
        );
    }

    private async Task<WithRawResponse<SharedPaymentProviderErrorList>> ErrorsInternalAsyncCore(
        string allowanceId,
        AllowancesErrorsRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<SharedPaymentProviderErrorList>(
                    responseBody
                )!;
                return new WithRawResponse<SharedPaymentProviderErrorList>()
                {
                    Data = responseData,
                    RawResponse = new global::BasisTheory.Client.RawResponse()
                    {
    ...
    private async Task<WithRawResponse<AllowanceVerificationResponse>> VerifyAsyncCore(
        string allowanceId,
        object request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<AllowanceVerificationResponse>(
                    responseBody
                )!;
                return new WithRawResponse<AllowanceVerificationResponse>()
                {
                    Data = responseData,
                    RawResponse = new global::BasisTheory.Client.RawResponse()
                    {
    ...
    /// );
    /// </code></example>
    public async Task<Pager<Allowance>> ListAsync(
        AllowancesListRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<Allowance> CreateAsync(
        CreateAllowanceRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    ...
    /// </code></example>
    public WithRawResponseTask<Allowance> GetAsync(
        string allowanceId,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<Allowance>(
            GetAsyncCore(allowanceId, options, cancellationToken)
        );
    }
    ...
    {
        return new WithRawResponseTask(DeleteAsyncCore(allowanceId, options, cancellationToken));
    }
    ...
    /// </code></example>
    public WithRawResponseTask<Allowance> UpdateAsync(
        string allowanceId,
        AllowancesUpdateRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    ...
    {
        return new WithRawResponseTask<Allowance>(
            UpdateAsyncCore(allowanceId, request, options, cancellationToken)
        );
    }
    ...
    /// );
    /// </code></example>
    public async Task<Pager<SharedPaymentProviderError>> ErrorsAsync(
        string allowanceId,
        AllowancesErrorsRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        ...
        >
            .CreateInstanceAsync(
                ...
                options,
                async (request, options, cancellationToken) =>
                    await ErrorsInternalAsync(allowanceId, request, options, cancellationToken)
                        .WithRawResponse(),
                (request, cursor) =>
                {
                    request.Start = cursor;
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<AllowanceVerificationResponse> VerifyAsync(
        string allowanceId,
        object request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    ...
    {
        return new WithRawResponseTask<AllowanceVerificationResponse>(
            VerifyAsyncCore(allowanceId, request, options, cancellationToken)
        );
    }
}
