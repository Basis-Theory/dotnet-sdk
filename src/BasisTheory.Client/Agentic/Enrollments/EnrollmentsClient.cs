...
public partial class EnrollmentsClient
{
    ...
    /// </summary>
    private async Task<EnrollmentList> ListInternalAsync(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                return JsonUtils.Deserialize<EnrollmentList>(responseBody)!;
            }
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                return JsonUtils.Deserialize<Enrollment>(responseBody)!;
            }
            catch (JsonException e)
            {
                throw new BasisTheoryException("Failed to deserialize response", e);
    ...
    /// </code></example>
    public async Task<Enrollment> RetryAsync(
        string enrollmentId,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
